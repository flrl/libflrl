...
uint64_t xoshiro256plusplus_next(struct state256 *state) {
...
void xoshiro256plusplus_jump(struct state256 *state) {
...
void xoshiro256plusplus_long_jump(struct state256 *state) {
